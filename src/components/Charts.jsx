...
//       <h2 class="mb-4 text-lg font-extrabold text-gray-900 dark:text-white md:text-xl lg:text-3xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Total Movies Watched</span> Genres:</h2>
//         {/* <h2>Total Movies Watched</h2> */}
//         <canvas id="moviesWatchedChart"></canvas>
//       </div>
//       <div className="w-full lg:w-1/2 p-4 text-center">
//       <h2 class="mb-4 pt-4 text-lg font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-3xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Ratings</span> Distributions:</h2>
